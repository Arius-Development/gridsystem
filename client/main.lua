            ...
            if distance < zone.drawDistance then
                ...
                if zone.show3D then
                    ...
                    elseif zone.texture then
                        ...
                        DrawMarker(9, zone.pos, 0.0, 0.0, 0.0, 90.0, 0.0, 0.0, zone.scale.x, zone.scale.y, zone.scale.z, zone.color.r, zone.color.g, zone.color.b, 200, false, true, 2, false, dict, zone.texture or "default", false)
                    end
                end
